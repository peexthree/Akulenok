...
const steps = [
  ...
  },
  {
    ...
    desc: "Перед водой тренер проводит легкую гимнастику на суше, чтобы разогреть мышцы малыша и наладить контакт.",
    img: "/img/gallery/gallery-01.jpeg"
  },
  {
    num: "03",
    title: "Бережное плавание",
    desc: "Погружение в воду температурой 32-33°C. Без криков и стресса, только в ритме ребенка.Для Вас всегда уровень комфорт плюс ",
    img: "/img/gallery/gallery-04.jpeg"
  },
  {
    num: "04",
    title: "Отдых",
    desc: "После занятия можно погреться в теплой детской комнате, выпить ароматный кофе и спокойно отдохнуть.",
      ...
      <Container>
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
          ...
          <div className="w-full lg:w-1/3 flex flex-col items-start lg:sticky lg:top-32 lg:h-[calc(100vh-8rem)]">
            ...
            >
              Мягкая адаптация шаг за шагом. Вы поймете, что плавать с грудничком — это не страшно, а очень приятно и полезно.
            </motion.p>
          </div>
