...
const steps = [
  ...
  },
  {
    ...
    img: "/img/gallery/q (5).webp"
  },
  {
    num: "04",
    title: "Отдых",
    desc: "После занятия можно отдохнуть в зоне ожидания, выпить оздоровительный кислородный коктейль или ароматный кофе.",
    img: "/img/gallery/q (2).webp"
  }
];
