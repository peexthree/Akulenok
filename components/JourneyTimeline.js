...
const steps = [
  {
    ...
    img: "/img/gallery/gallery-02.jpg"
  },
  {
    num: "02",
    ...
    img: "/img/gallery/gallery-01.jpg"
  },
  {
    num: "03",
    title: "Бережное плавание",
    desc: "Погружение в воду температурой 33-34°C. Без криков и стресса, только в ритме ребенка.",
    img: "/img/gallery/gallery-04.jpg"
  },
  {
    num: "04",
    title: "Отдых  ",
    desc: "После занятия можно погреться в теплой детской сауне и спокойно покормить малыша в зоне отдыха.",
    img: "/img/gallery/gallery-05.jpg"
  }
];
