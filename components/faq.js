...
const faqs = [
  {
    ...
    a: "Нет. Температура воды в бассейне поддерживается на уровне 32-33°C, а воздуха - 30-32°C. После занятия можно погреться  и спокойно высохнуть в теплой раздевалке."
  },
  {
    q: "Как вы чистите воду? Есть ли хлорка?",
    a: "да есть , так как это требование санитарных норм, мы используем гипохлорит натрия высокой очистки , который не вызывает аллергии и добавляется в минимальном количестве . вода проходит 3 степени очистки : песчаный фильтр , ультрафиолетовые лампы и дезинфекция гипохлоритом натрия . Фильтрация идет 24/7 ,с ежедневным , частичным обновлением."
  },
  {
    q: "Нужна ли справка для первого занятия?",
    a: "Да, об отсутствии противопоказаний с отрицательным анализом на энтеробиоз или яйца глист. И все  ."
  },
  {
