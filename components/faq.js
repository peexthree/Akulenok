...
const faqs = [
  {
    ...
    a: "Нет. Температура воды в бассейне поддерживается на уровне 33-34°C, а воздуха — 35°C. После занятия можно погреться  и спокойно высохнуть в теплой раздевалке."
  },
  {
