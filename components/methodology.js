...
const services = [
  {
    ...
    desc: "Для малышей от 3 до 12 месяцев. Адаптация к воде, сформирование правильных двигательных навыков, укрепление мышц и иммунитета в игровом формате.",
    color: "from-sky-100 to-teal-50",
    icon3d: "/img/3d-icons/1.webp"
  },
  {
    title: "Гидрореабилитация",
    desc: "Специализированные занятия для детей с особенностями развития (ДЦП, аутизм, задержка речи и т.п.). Работа по сертификатам реабилитации.",
    color: "from-teal-100 to-emerald-50",
    icon3d: "/img/3d-icons/2.webp"
  },
  {
    title: "Раннее плавание",
    desc: "Для детей от 1 до 7 лет. Обучение базовым навыкам плавания, ныряния и правильного дыхания в воде. По авторской мягкой методике Осознанного погружения. Развитие навыков само спасения на воде.",
