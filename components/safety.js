...
const safetyFacts = [
  {
    title: "Тройная очистка",
    desc: "Песчаные фильтры, УФ-лампы и ионы серебра. Мы не используем агрессивный жидкий хлор.",
    icon: (
  ...
  },
  {
    ...
    desc: "Вода полностью безопасна даже при случайном проглатывании малышом во время ныряния.",
    icon: (
      <svg className="w-8 h-8 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
